...
const Account = () => {
  ...
  return (
    <div className="pt-[100px] flex flex-col max-w-[400px] w-full mx-auto p-4">
      ...
      <button
        className="flex items-center justify-center p-3 bg-gray-400 border border-gray-600 my-2 hover:bg-gray-300"
        onClick={() => signIn()}
      >
      ...
      <button
        className="flex items-center justify-center p-3 bg-blue-300 border border-blue-600 my-2 hover:bg-blue-400"
        onClick={() => signIn()}
      >
        <FaGoogle className="mr-2 text-blue-700" />
        Sign in with<span className="font-bold pl-1 text-blue-700">Google</span>
      </button>
    </div>
  );
};
